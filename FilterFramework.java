...
* in order to be considered valid system filters. Filters as stand alone threads until the input port no longer
...
public class FilterFramework extends Thread
{
	...
	****************************************************************************/
	...
	byte ReadFilterInputPort(int inputPortNo) throws EndOfStreamException
	{
		byte datum = 0;
	...
	****************************************************************************/
	...
	private boolean EndOfInputStream(int inputPortNo)
	{
		if (inputFilter.elementAt(inputPortNo).isAlive())
			return false;
		else
			return true;
	} // EndOfInputStream
